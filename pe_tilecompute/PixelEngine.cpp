...
//2022-3-26
//1. add wgs84 area compute codes
//2. add statistic method for direct call without V8
string PixelEngine::pejs_version = string("2.7.1.0 2022-03-26");
...
template<typename T>
bool PixelEngine::computeStatistic(
                            ...
                            for(int x_in_tile = seg_x0_in_tile ; x_in_tile < seg_x1_in_tile ; ++ x_in_tile )
                            {
                                ...
                                for(int ib=0;ib<nbands;++ib){
                                    ...
                                    if( val==fillval ){
                                        ...
                                        retBandStatDataVec[ib].areakm2=wclla.computeArea(tilez,tiley,y_in_tile) ;
                                    }
